...
class MainComponent extends React.Component {
  ...
  render () {
    return (
      <div style={this.state.isBoardCentered ? {'height':'100vh','width':'100%','display':'flex', 'justify-content':'center' }:{}}>
        <span
          className="menu-icon"
  ...
  __renderWelcomeDialog () {
    return (
      ...
      >
        <Modal.Header closeButton onClick={() => { this.setState({ isBoardCentered: true }) }}>
